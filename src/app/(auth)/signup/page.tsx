...
const HIGHLIGHTS = [
  { title: 'Official student registration', copy: 'Set up your technical profile, spoken languages, and soft skills.' },
  { title: 'Form & lead hackathon teams', copy: 'Recruit teammates, manage invites, and lock in your six-member roster.' },
  { title: 'Faculty & mentor matching', copy: 'Connect directly with verified mentors from across departments.' },
];
...
function SignUpContent() {
  ...
  useEffect(() => {
    if (urlError === 'domain_not_allowed') {
      setError('Access restricted: Please register using your official GL Bajaj email ID only (@glbajajgroup.org).');
      ...
      <aside className="section-pearl relative hidden w-[44%] shrink-0 overflow-hidden lg:flex lg:flex-col lg:justify-between lg:px-12 lg:py-14 xl:px-16">
        ...
        <Reveal delay={0.75}>
          <p className="relative text-label uppercase text-muted">
            Smart India Hackathon internal evaluation portal
          </p>
        </Reveal>
      </aside>
        ...
        <div className="relative w-full max-w-sm">
          ...
          <Reveal delay={0.06}>
            ...
            <p className="mt-2 text-sm text-muted">
              Use your official GL Bajaj college workspace email (@glbajajgroup.org) to set up your profile.
            </p>
          </Reveal>
