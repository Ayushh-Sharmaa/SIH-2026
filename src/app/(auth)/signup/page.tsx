...
function SignupTemplate({
  ...
  // Passwordless troubleshooting account (see src/lib/sandbox.ts)
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              <label htmlFor="password" className="block text-xs font-bold uppercase tracking-wider text-muted mb-1.5">
                Password {isSandbox && <span className="normal-case font-medium">(not required)</span>}
              </label>
              <input
                id="password"
                name="password"
                ...
                className="block w-full rounded-xl bg-background/30 border border-card-border px-4 py-2.5 text-foreground placeholder-muted focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary text-xs transition-all disabled:opacity-50"
              />
            </div>
